...
<p align="center">
  <img src="images/menace.gif" width="80%" alt="Tiffany hexapod demo"/>
</p>
...
| **SLAM Toolbox mapping** | Asynchronous, pose-graph-based live mapping against `/scan` |
...
<table>
<tr><td align="center">
  <video src="https://github.com/user-attachments/assets/2c575583-0aa3-4adb-b363-7a5e74f4dceb" controls width="720"></video>
</td></tr>
</table>
...
Clone the repository into a colcon workspace (the repo root itself is the workspace, with the package under `src/hexapod_ws`):
...
Once dependencies are installed, see [Build](#build) to compile the workspace and [Usage](#usage) to launch it.
